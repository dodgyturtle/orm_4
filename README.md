...
### Редактирование покемонов
Создайте пользователя для доступа в панель администрирования

```sh
python3 manage.py createsuperuser
```

Адрес для доступа к панели администрирования: `http://127.0.0.1:8000/admin`

Поля выделенные **bold** шрифтом обязателльны для ввода.
